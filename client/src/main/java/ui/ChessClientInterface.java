...
public class ChessClientInterface {
    ...
    private String eval(String input, Scanner lineReader) throws Exception {
        ...
        if (!this.gameStatus) {
            //phase 5 stuff.
            if (this.loginStatus) {
                return loggedInHandler(input, lineReader);
            } else {
                return loggedOutHandler(input, lineReader);
            }
        } else {
            return activeGameHandler(input, lineReader);
        }
    }

    private String loggedInHandler(String input, Scanner lineReader) throws Exception {
        switch (input) {
            case "logout" -> {
    ...
    private String loggedOutHandler(String input, Scanner lineReader) throws Exception{
        switch (input) {
            case "register" -> {
    ...
    private String activeGameHandler(String input, Scanner lineReader) throws Exception {
        switch (input) {
            case "help" -> {
